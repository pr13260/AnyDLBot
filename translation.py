...
URL | filename | username | password"""
    ...
    NO_VOID_FORMAT_FOUND = "something is wrong with the URL you gave me 🤦‍♀️. If you think this could be a bug please report @thestarkarmy13260\n<b>YouTubeDL</b> said: {}"
    USER_ADDED_TO_DB = "User <a href='tg://user?id={}'>{}</a> added to {} till {}."
    CURENT_PLAN_DETAILS = """Current plan details
--------

Plan name: <a href='https://t.me/thestarkarmy13260'>{}</a>
Expires on: {}"""
...
Send /me to know current plan details"""
    ...
    EXTRACT_ZIP_ERRS_OCCURED = "Sorry. Errors occurred while processing compressed file. Please check everything again twice, and if the issue persists, report this to <a href='https://telegram.dog/thestarkarmy13260\n<b>YouTubeDL</b>'>@hero</a>"
    EXTRACT_ZIP_STEP_TWO = """Select file_name to upload from the below options.
You can use /rename command after receiving file to rename it with custom thumbnail support."""
    GET_LINK_ERRS_OCCURED = "Sorry the following Errors occurred: \n{}\nPlease check everything again twice, and if the issue persists, report this to <a href='https://telegram.dog/thestarkarmy13260\n<b>YouTubeDL</b>'>@hero</a>"
...
/upgrade or Try today midnight later."""
    ...
    FED_UP_WITH_CRAP = "This bot is no longer leeching links for free users. Bot is open source, and you can deploy your own telegram upload by clicking on the links, available in GitHub README. or, Better /upgrade the subscription to continue using this bot."
